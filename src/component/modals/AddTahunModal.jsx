...
const AddTahunModal = ({ setIsOpenModalAdd, getTahun }) => {
  ...
  const saveTahun = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:5000/tahun", formData);
      ...
      <form onSubmit={saveTahun}>
        ...
        >
          <div className="flex items-start justify-between p-4 border-b rounded-t">
            <h3 className="text-xl font-semibold text-gray-900">Tambah Tahun</h3>
            <button
